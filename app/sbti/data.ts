...
export const questions: Question[] = [
  // ── 自我模型 S1 自尊自信 ──
  {
    ...
    text: '你发了条朋友圈，点赞寥寥、评论全无，两小时后你会？',
    options: [
      { text: '没事，我发出去是因为我觉得值得发。', scores: { S1: 3 } },
      { text: '有点尴尬，暗暗希望有人来救场。', scores: { S1: 2 } },
      { text: '悄悄删了，这辈子没发过这条。', scores: { S1: 1 } },
    ],
  },
  {
    id: 2, dim: 'S1', group: '自我模型',
    text: '领导当众点名批评你，但你觉得这锅不是你的，你会？',
    options: [
      { text: '礼貌但坚定地说清楚事实。', scores: { S1: 3 } },
      { text: '当场忍住，事后找机会解释。', scores: { S1: 2 } },
      { text: '沉默接受，在心里把自己骂一遍。', scores: { S1: 1 } },
    ],
  },
  ...
  // ── 自我模型 S2 自我清晰度 ──
  {
    ...
    text: '"你最怕什么？"——这个问题，你能在5秒内答出来吗？',
    options: [
      { text: '能，我对自己的恐惧挺清楚的。', scores: { S2: 3 } },
      { text: '大概知道，但说不太准。', scores: { S2: 2 } },
      { text: '脑子空白，感觉什么都怕又什么都不怕。', scores: { S2: 1 } },
    ],
  },
  {
    id: 4, dim: 'S2', group: '自我模型',
    text: '你在某件事上纠结了很久，根本原因是？',
    options: [
      { text: '我清楚自己要什么，只是代价太高。', scores: { S2: 3 } },
      { text: '大方向知道，细节想不清楚。', scores: { S2: 2 } },
      { text: '我不知道自己到底想要什么。', scores: { S2: 1 } },
    ],
  },
  ...
  // ── 自我模型 S3 核心价值 ──
  {
    ...
    text: '如果可以选，你更想成为哪种人？',
    options: [
      { text: '有点东西、持续进步、被人记住的那种。', scores: { S3: 3 } },
      { text: '普普通通，但真实快乐的那种。', scores: { S3: 2 } },
      { text: '没有人烦我、能平静活着的那种。', scores: { S3: 1 } },
    ],
  },
  {
    id: 6, dim: 'S3', group: '自我模型',
    text: '你刷到一个比你年轻很多却已经很厉害的人，你的第一反应是？',
    options: [
      { text: '燃了，我也要搞。', scores: { S3: 3 } },
      { text: '酸了一秒，然后划走。', scores: { S3: 2 } },
      { text: '关我什么事，又不是同一个赛道。', scores: { S3: 1 } },
    ],
  },
  ...
  // ── 情感模型 E1 依恋安全感 ──
  {
    ...
    text: '你给在意的人发了消息，对方"已读不回"超过两小时，你会？',
    options: [
      { text: '该干嘛干嘛，他忙呢。', scores: { E1: 3 } },
      { text: '拿着手机反复看有没有新消息。', scores: { E1: 2 } },
      { text: '脑补出了一出完整的悲剧。', scores: { E1: 1 } },
    ],
  },
  {
    id: 8, dim: 'E1', group: '情感模型',
    text: '关系很铁的朋友开始越来越少回你，你的第一直觉是？',
    options: [
      { text: '他最近可能有事，等等看。', scores: { E1: 3 } },
      { text: '有点不安，暗中观察是不是我哪里让他不开心了。', scores: { E1: 2 } },
      { text: '一定是我哪里出了问题，开始反复复盘。', scores: { E1: 1 } },
    ],
  },
  ...
  // ── 情感模型 E2 情感投入度 ──
  {
    ...
    text: '认定一段感情之后，你的状态是？',
    options: [
      { text: '整个人都扑进去了，收不住。', scores: { E2: 3 } },
      { text: '用心投入，但给自己留着退路。', scores: { E2: 2 } },
      { text: '慢慢来，不到位就不算数。', scores: { E2: 1 } },
    ],
  },
  {
    id: 10, dim: 'E2', group: '情感模型',
    text: '一段在乎的关系突然结束，你需要多久才能"出戏"？',
    options: [
      { text: '很长，那部分自己得重新长出来。', scores: { E2: 3 } },
      { text: '难受一段时间，但能慢慢代谢掉。', scores: { E2: 2 } },
      { text: '不算太久，我早备好了后手。', scores: { E2: 1 } },
    ],
  },
  ...
  // ── 情感模型 E3 边界与依赖 ──
  {
    ...
    text: '你在一段亲密关系里最需要的是？',
    options: [
      { text: '各自有空间，靠近是选择不是默认。', scores: { E3: 3 } },
      { text: '既要亲密也要喘气，可以调节。', scores: { E3: 2 } },
      { text: '贴在一起才踏实，距离让我不安。', scores: { E3: 1 } },
    ],
  },
  {
    id: 12, dim: 'E3', group: '情感模型',
    text: '对方说"我需要点自己的时间"，你的感受是？',
    options: [
      { text: '好啊，我也正好想一个人待着。', scores: { E3: 3 } },
      { text: '能理解，但还是想多确认一次没事吧。', scores: { E3: 2 } },
      { text: '有点慌，是不是不想理我了？', scores: { E3: 1 } },
    ],
  },
  ...
  // ── 态度模型 A1 世界观倾向 ──
  {
    ...
    text: '网上陌生人突然私信你"我们能做朋友吗"，你的反应是？',
    options: [
      { text: '可以聊聊，说不定挺有意思。', scores: { A1: 3 } },
      { text: '先观望，不急着建立关系。', scores: { A1: 2 } },
      { text: '警觉，他图什么？', scores: { A1: 1 } },
    ],
  },
  {
    id: 14, dim: 'A1', group: '态度模型',
    text: '你对"陌生人大多数情况下是善意的"这句话的态度？',
    options: [
      { text: '同意，不应该把人想得那么坏。', scores: { A1: 3 } },
      { text: '看情况，得验证一下才知道。', scores: { A1: 2 } },
      { text: '太天真，善意是用来被辜负的。', scores: { A1: 1 } },
    ],
  },
  ...
  // ── 态度模型 A2 规则与灵活度 ──
  {
    ...
    text: '你发现一个小漏洞，规则没有明说不能用，你会？',
    options: [
      { text: '不用，规则的精神比文字更重要。', scores: { A2: 3 } },
      { text: '看情况，钻个小空无伤大雅。', scores: { A2: 2 } },
      { text: '用啊，没写禁止就不算违规。', scores: { A2: 1 } },
    ],
  },
  {
    id: 16, dim: 'A2', group: '态度模型',
    text: '别人跟你说"做人别太死板，变通一下"，你的回应是？',
    options: [
      { text: '不一定，边界就是边界，不随便变通。', scores: { A2: 3 } },
      { text: '有道理，但得看是哪方面的事。', scores: { A2: 2 } },
      { text: '对，死守规矩是在为难自己。', scores: { A2: 1 } },
    ],
  },
  ...
  // ── 态度模型 A3 人生意义感 ──
  {
    ...
    text: '凌晨三点刷手机时突然冒出"我这样活着有什么意义"的念头，你的处理方式是？',
    options: [
      { text: '还好，我大概知道自己在往哪走。', scores: { A3: 3 } },
      { text: '偶尔这样，睡一觉就好了。', scores: { A3: 2 } },
      { text: '嗯，然后继续刷手机。', scores: { A3: 1 } },
    ],
  },
  {
    id: 18, dim: 'A3', group: '态度模型',
    text: '如果明天你就会消失，今天你会感到遗憾的是？',
    options: [
      { text: '有几件事没做完，我知道是什么。', scores: { A3: 3 } },
      { text: '大概有，但不确定具体是什么。', scores: { A3: 2 } },
      { text: '不知道，想不出来特别遗憾的事。', scores: { A3: 1 } },
    ],
  },
  ...
  // ── 行动驱力 Ac1 动机导向 ──
  {
    ...
    text: '你愿意做一件高风险但可能很厉害的事吗？',
    options: [
      { text: '愿意，赢的可能性让我兴奋。', scores: { Ac1: 3 } },
      { text: '看风险大小，控制范围内可以试试。', scores: { Ac1: 2 } },
      { text: '不太想，稳稳当当更重要。', scores: { Ac1: 1 } },
    ],
  },
  {
    id: 20, dim: 'Ac1', group: '行动驱力模型',
    text: '什么样的状态会让你感觉自己"活得有点意思"？',
    options: [
      { text: '在进步，在推进，感觉有点在赢。', scores: { Ac1: 3 } },
      { text: '完成了任务，没有乱，舒服就好。', scores: { Ac1: 2 } },
      { text: '没有任何压力、随便摆烂的状态。', scores: { Ac1: 1 } },
    ],
  },
  ...
  // ── 行动驱力 Ac2 决策风格 ──
  {
    ...
    text: '朋友临时拉你去蹦迪，你今晚本来没计划，你会？',
    options: [
      { text: '走！人生就要随机应变。', scores: { Ac2: 3 } },
      { text: '想一下，如果明天没事就去。', scores: { Ac2: 2 } },
      { text: '心动了，但还是拒绝，没准备好。', scores: { Ac2: 1 } },
    ],
  },
  {
    id: 22, dim: 'Ac2', group: '行动驱力模型',
    text: '要在两个差不多的选项里做决定，你通常怎么搞？',
    options: [
      { text: '哪个顺眼选哪个，想太多浪费时间。', scores: { Ac2: 3 } },
      { text: '稍微权衡一下再选，不会太纠结。', scores: { Ac2: 2 } },
      { text: '左右横跳，怕选错就不太敢选。', scores: { Ac2: 1 } },
    ],
  },
  ...
  // ── 行动驱力 Ac3 执行模式 ──
  {
    ...
    text: '有件重要的事要做，但当下你不想动，你会？',
    options: [
      { text: '强迫自己开始，哪怕先做五分钟。', scores: { Ac3: 3 } },
      { text: '缓一缓，但给自己设个底线时间。', scores: { Ac3: 2 } },
      { text: '等"状态来了"再说，逼自己反而更难。', scores: { Ac3: 1 } },
    ],
  },
  {
    id: 24, dim: 'Ac3', group: '行动驱力模型',
    text: '一件事你拖了很久还没开始，根本原因更可能是？',
    options: [
      { text: '太忙了，真没时间。', scores: { Ac3: 3, So1: 3 } },
      { text: '有点懒，但压线了肯定会搞。', scores: { Ac3: 2, So1: 2 } },
      { text: '拖是因为怕做了做不好。', scores: { Ac3: 1, So1: 1 } },
    ],
  },
  ...
  // ── 社交模型 So1 社交主动性 ──
  {
    ...
    text: '公司来了新同事，大家都没去搭话，你会？',
    options: [
      { text: '主动去打个招呼，帮忙破冰。', scores: { So1: 3 } },
      { text: '等个合适的机会，不急着出头。', scores: { So1: 2 } },
      { text: '等他来找我，我不太会主动。', scores: { So1: 1 } },
    ],
  },
  {
    ...
    text: '你现在的社交能量储量大概是？',
    options: [
      { text: '满格，还想认识更多有意思的人。', scores: { So1: 3 } },
      { text: '还行，不排斥但也不太主动找。', scores: { So1: 2 } },
      { text: '快耗尽了，光维护现有关系就够累的。', scores: { So1: 1 } },
    ],
  },
  ...
  // ── 社交模型 So2 人际边界感 ──
  {
    ...
    text: '周末你最理想的放松方式是？',
    options: [
      { text: '约一堆朋友出去浪，热闹就是治愈。', scores: { So2: 1, So1: 3 } },
      { text: '关门谢客，一个人宅着充电。', scores: { So2: 3, So1: 1 } },
  ...
  // ── 隐藏题（饮酒触发）──
  {
    ...
    text: '谈谈你对喝酒这件事的哲学立场。',
    options: [
      { text: '小酌怡情，知道节制。', scores: { So2: 2 } },
      { text: '要喝就喝透，喝一半不如不喝。', scores: { So2: 1 } },
      {
        text: '我平时把白酒装保温杯当白水喝，酒精是我唯一认可的生产力工具。',
        scores: { So2: 1 },
        drunkUnlock: true,
      },
    ],
  ...
  // ── 社交模型 So3 表达与真实度 ──
  {
    ...
    text: '你在不同场合下的自我呈现，有多大差距？',
    options: [
      { text: '差很多，我会针对场合切换模式。', scores: { So3: 3 } },
      { text: '有区别，但核心是同一个人。', scores: { So3: 2 } },
      { text: '基本一致，我就这样，没什么版本。', scores: { So3: 1 } },
    ],
  },
  {
    id: 30, dim: 'So3', group: '社交模型',
    text: '你说出口的话，和你真正想说的，差了多远？',
    options: [
      { text: '有时候差很远，我懂得"分层发放"。', scores: { So3: 3 } },
      { text: '基本一致，偶尔过滤一下措辞。', scores: { So3: 2 } },
      { text: '差不多，我不太擅长说违心的话。', scores: { So3: 1 } },
    ],
  },
  ...
  // ── 综合收尾 ──
  {
    ...
    text: '最后一题：此刻做这个测试，你的心理状态是？',
    options: [
      { text: '朋友发来的，随手点进来测着玩。', scores: { So2: 2, A2: 2 } },
      { text: '自己主动找的，想认真了解一下自己。', scores: { S2: 3, A3: 2 } },
      { text: '无聊，手机划着划着划进来了。', scores: { A3: 1, Ac3: 1 } },
    ],
  },
]
